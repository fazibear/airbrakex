defmodule Airbrakex.LoggerParserTest do
  ...
  test "should parse exception from logs" do
    ...
    result = %{
      backtrace: [
        %{"file" => "(ecto) lib/ecto/repo/queryable.ex", "function" => " Ecto.Repo.Queryable.one!/4", "line" => 57},
        %{"file" => "(test) web/channels/game_channel.ex", "function" => " Test.GameChannel.join/3", "line" => 15},
        %{"file" => "(phoenix) lib/phoenix/channel/server.ex", "function" => " Phoenix.Channel.Server.init/1", "line" => 154},
        %{"file" => "(stdlib) gen_server.erl", "function" => " :gen_server.init_it/6", "line" => 328},
        %{"file" => "(stdlib) proc_lib.erl", "function" => " :proc_lib.init_p_do_apply/3", "line" => 239}
      ],
